...
[NOTE]
_Due to page limit, only 1 approve command example is included. Refer to User Guide 3.9 and 3.10 for more examples._
...
[NOTE]
_Due to page limit, only 1 invdividual approve command example is included. Refer to User Guide 3.9 and 3.10 for more examples._
